              ...
              <div>
                ...
                <div className="mt-1 flex items-center space-x-2">
                  <input
                    ...
                    className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm font-mono tracking-widest text-center"
                    placeholder="AB"
                    maxLength={2}
                  />
