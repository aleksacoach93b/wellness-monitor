...
export default function BodyMap({ view, mode, onAreaClick, selectedAreas, onViewChange, onContinue, onClose }: BodyMapProps) {
    ...
    >
      ...
      <g>
        <g id="_Слой_1" data-name="Слой_1">
          <g id="Anterior_Body">
        {/* Face and Skin - Background layer (NOT CLICKABLE) */}
        <path 
          id="Face and Skin"
          fill="#e5e7eb"
          stroke="#d1d5db" 
        ...
        <path 
          ...
          onClick={(e) => handleAreaClick('Top Head', e)}
        />
            
            {/* Right Pectoralis Major */}
            <path 
              id="Right Pectoralis Major"
              className="body-area"
              fill={getAreaColor('Right Pectoralis Major')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Pectoralis Major', e)}
            />
            
            {/* Left Pectoralis Major */}
            <path 
              id="Left Pectoralis Major"
              className="body-area"
              fill={getAreaColor('Left Pectoralis Major')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Pectoralis Major', e)}
            />
            
            {/* Right Upper Rectus Abdominis */}
            <path 
              id="Right Upper Rectus Abdominis"
              className="body-area"
              fill={getAreaColor('Right Upper Rectus Abdominis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Upper Rectus Abdominis', e)}
            />
            
            {/* Left Upper Rectus Abdominis */}
            <path 
              id="Left Upper Rectus Abdominis"
              className="body-area"
              fill={getAreaColor('Left Upper Rectus Abdominis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Upper Rectus Abdominis', e)}
            />
            
            {/* Right Middle Rectus Abdominis */}
            <path 
              id="Right Middle Rectus Abdominis"
              className="body-area"
              fill={getAreaColor('Right Middle Rectus Abdominis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Middle Rectus Abdominis', e)}
            />
            
            {/* Left Middle Rectus Abdominis */}
            <path 
              id="Left Middle Rectus Abdominis"
              className="body-area"
              fill={getAreaColor('Left Middle Rectus Abdominis')}
              stroke="#374151" 
              strokeWidth="1"
              d="M303.852,263.617c2.32.556,2.731,1.335,4.96,2.409,2.755,1.328,5.468,2.746,8.144,4.226,4.152,2.296,9.261,4.681,12.539,8.216.127.137.252.275.364.426,2.649,3.571,2.765,15.666,2.534,16.472-.23.806-30.132,3.168-31.62-1.094-1.258-3.602-.295-7.426-.432-11.181-.199-5.423-.495-11.886.086-16.724.048-.4,2.333-3.011,3.424-2.75Z"
              onClick={(e) => handleAreaClick('Left Middle Rectus Abdominis', e)}
            />
            
            {/* Right Lower Rectus Abdominis */}
            <path 
              id="Right Lower Rectus Abdominis"
              className="body-area"
              fill={getAreaColor('Right Lower Rectus Abdominis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Lower Rectus Abdominis', e)}
            />
            
            {/* Left Lower Rectus Abdominis */}
            <path 
              id="Left Lower Rectus Abdominis"
              className="body-area"
              fill={getAreaColor('Left Lower Rectus Abdominis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Lower Rectus Abdominis', e)}
            />
            
            {/* Right Biceps Brachii SH */}
            <path 
              id="Right Biceps Brachii SH"
              className="body-area"
              fill={getAreaColor('Right Biceps Brachii SH')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Biceps Brachii SH', e)}
            />
            
            {/* Left Biceps Brachii SH */}
            <path 
              id="Left Biceps Brachii SH"
              className="body-area"
              fill={getAreaColor('Left Biceps Brachii SH')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Biceps Brachii SH', e)}
            />
            
            {/* Right Biceps Brachii LH */}
            <path 
              id="Right Biceps Brachii LH"
              className="body-area"
              fill={getAreaColor('Right Biceps Brachii LH')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Biceps Brachii LH', e)}
            />
            
            {/* Left Biceps Brachii LH */}
            <path 
              id="Left Biceps Brachii LH"
              className="body-area"
              fill={getAreaColor('Left Biceps Brachii LH')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Biceps Brachii LH', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Right Rectus Femoris')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Rectus Femoris', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Left Rectus Femoris')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Rectus Femoris', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Right Vastus Lateralis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Vastus Lateralis', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Left Vastus Lateralis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Vastus Lateralis', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Right Vastus Medialis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Vastus Medialis', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Left Vastus Medialis')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Vastus Medialis', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Right Tibialis Anterior')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Tibialis Anterior', e)}
            />
            ...
            <path 
              ...
              className="body-area"
              fill={getAreaColor('Left Tibialis Anterior')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Tibialis Anterior', e)}
            />
            
            {/* Right Digitorum Longus */}
            <path 
              id="Right Digitorum Longus"
              className="body-area"
              fill={getAreaColor('Right Digitorum Longus')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Digitorum Longus', e)}
            />
            
            {/* Left Digitorum Longus */}
            <path 
              id="Left Digitorum Longus"
              className="body-area"
              fill={getAreaColor('Left Digitorum Longus')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Digitorum Longus', e)}
            />
            ...
            <path 
              id="Right Deltoideus"
              className="body-area"
              fill={getAreaColor('Right Deltoideus')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Deltoideus', e)}
            />
            ...
            <path 
              id="Left Deltoideus"
              className="body-area"
              fill={getAreaColor('Left Deltoideus')}
              stroke="#374151" 
              strokeWidth="1"
              d="M353.409,157.599c2.08,1.355,4.93,1.979,7.186,3.019,6.647,3.063,12.813,6.385,12.751,14.538-.048,6.345-.81,13.214,2.627,18.548,2.188,3.395,5.075,6.244,7.634,9.347,2.531,3.068,4.025,5.849,8.338,3.594,10.118-5.289,17.109-15.684,16.215-27.328-.494-6.438-3.415-12.654-7.999-17.194-5.089-5.04-10.033-9.995-16.604-13.184-9.005-4.369-19.032-2.763-27.149,2.833-2.937,2.025-3.001,5.826-3.001,5.826Z"
              onClick={(e) => handleAreaClick('Left Deltoideus', e)}
            />
            
            {/* Right Forearm Lateral */}
            <path 
              id="Right Forearm Lateral"
              className="body-area"
              fill={getAreaColor('Right Forearm Lateral')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Forearm Lateral', e)}
            />
            
            {/* Left Forearm Lateral */}
            <path 
              id="Left Forearm Lateral"
              className="body-area"
              fill={getAreaColor('Left Forearm Lateral')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Forearm Lateral', e)}
            />
            
            {/* Right Forearm Central */}
            <path 
              id="Right Forearm Central"
              className="body-area"
              fill={getAreaColor('Right Forearm Central')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Forearm Central', e)}
            />
            
            {/* Left Forearm Central */}
            <path 
              id="Left Forearm Central"
              className="body-area"
              fill={getAreaColor('Left Forearm Central')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Forearm Central', e)}
            />
            
            {/* Right Forearm Medial */}
            <path 
              id="Right Forearm Medial"
              className="body-area"
              fill={getAreaColor('Right Forearm Medial')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Forearm Medial', e)}
            />
            
            {/* Left Forearm Medial */}
            <path 
              id="Left Forearm Medial"
              className="body-area"
              fill={getAreaColor('Left Forearm Medial')}
              stroke="#374151" 
              strokeWidth="1"
              d="M413.775,340.492c5.089,6.451,9.024,14.922,11.577,20.878,2.359,5.504,4.624,11.051,6.816,16.624,2.031,5.165,4.106,10.358,5.695,15.68.265.887,1.054,2.194.679,3.122-.956-.773-1.421-1.964-2.023-2.996-.634-1.086-1.232-2.192-1.811-3.307-1.369-2.636-2.636-5.325-3.869-8.027-2.797-6.131-5.41-12.344-8.097-18.523-2.309-5.311-4.597-10.675-7.387-15.756-.139-.253-.279-.505-.422-.755-6.681-11.749-8.754-14.975-11.519-21.886-2.765-6.911-8.754-18.2-7.833-20.274.642-1.444,2.957-3.755,3.968-4.492.353-.257.658,1.983.691,2.419,1.091,14.395,8.927,31.452,13.535,37.293Z"
              onClick={(e) => handleAreaClick('Left Forearm Medial', e)}
            />
            ...
            <path 
              id="Right Hand Front"
              className="body-area"
              fill={getAreaColor('Right Hand Front')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Hand Front', e)}
            />
            ...
            <path 
              id="Left Hand Front"
              className="body-area"
              fill={getAreaColor('Left Hand Front')}
              stroke="#374151" 
              strokeWidth="1"
              d="M457.491,400.651c-.952-.165-1.912-.208-2.875-.094-5.489.65-15.052,1.756-17.232,7.963-.253.721-.272,1.5-.279,2.263-.073,8.09.91,16.207,2.992,24.028.391,1.469.848,2.953,1.719,4.199,4.913,7.033,18.156,2.252,23.698-1.257,5.005-3.169,12.53-8.074,12.877-14.513.309-5.724-3.115-11.867-7.725-15.136-3.776-2.677-8.375-6.621-13.175-7.453Z"
              onClick={(e) => handleAreaClick('Left Hand Front', e)}
            />
            ...
            <path 
              id="Right 5th Finger"
              className="body-area"
              fill={getAreaColor('Right 5th Finger')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right 5th Finger', e)}
            />
            ...
            <path 
              id="Left 5th Finger"
              className="body-area"
              fill={getAreaColor('Left 5th Finger')}
              stroke="#374151" 
              strokeWidth="1"
              d="M449.484,445.346c.066,3.659.117,7.324.093,10.983-.021,2.354-.092,4.711-.328,7.055-.196,1.949-.243,5.565-1.473,7.101-.732.914-2.794-4.711-2.862-5.052-.32-1.595-.264-21.431-1.128-21.531,1.926.222,3.871.804,5.698,1.443Z"
              onClick={(e) => handleAreaClick('Left 5th Finger', e)}
            />
            ...
            <path 
              id="Right 4th Finger"
              className="body-area"
              fill={getAreaColor('Right 4th Finger')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right 4th Finger', e)}
            />
            ...
            <path 
              id="Left 4th Finger"
              className="body-area"
              fill={getAreaColor('Left 4th Finger')}
              stroke="#374151" 
              strokeWidth="1"
              d="M460.957,445.047c1.523,6.391,2.055,13.079,3.14,19.561.355,2.121.713,4.241,1.042,6.365.436,2.811.916,5.13.602,8.022-.029.268-.069.553-.242.76-.8.954-2.703-.017-3.288-.743-.646-.801-.908-1.841-1.073-2.856-.46-2.826-1.13-5.615-1.701-8.424-.865-4.257-1.679-8.525-2.54-12.783-.529-2.616-1.058-5.233-1.587-7.849-.064-.318-.126-.663.015-.956.287-.599,5.617-1.159,5.633-1.095Z"
              onClick={(e) => handleAreaClick('Left 4th Finger', e)}
            />
            ...
            <path 
              id="Right 3rd Finger"
              className="body-area"
              fill={getAreaColor('Right 3rd Finger')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right 3rd Finger', e)}
            />
            ...
            <path 
              id="Left 3rd Finger"
              className="body-area"
              fill={getAreaColor('Left 3rd Finger')}
              stroke="#374151" 
              strokeWidth="1"
              d="M471.083,442.211c.915.95,1.531,4.44,1.822,5.309.794,2.38,1.639,4.742,2.51,7.095,1.709,4.62,3.522,9.2,5.27,13.805,1.166,3.071,2.696,6.035,2.656,9.405-.022,1.801-2.25.911-3.191.465-3.017-1.428-3.4-3.799-4.533-6.595-.877-2.162-1.774-4.316-2.679-6.467-2.805-6.668-5.649-13.31-8.848-19.802-.119-.242-.241-.49-.268-.759-.244-2.389,5.37-2.642,6.781-2.696.169-.006.329.081.482.239Z"
              onClick={(e) => handleAreaClick('Left 3rd Finger', e)}
            />
            ...
            <path 
              id="Right 2nd Finger"
              className="body-area"
              fill={getAreaColor('Right 2nd Finger')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right 2nd Finger', e)}
            />
            ...
            <path 
              id="Right 1st Finger"
              className="body-area"
              fill={getAreaColor('Right 1st Finger')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right 1st Finger', e)}
            />
            ...
            <path 
              id="Left 1st Finger"
              className="body-area"
              fill={getAreaColor('Left 1st Finger')}
              stroke="#374151" 
              strokeWidth="1"
              d="M480.366,410.902c2.88,2.765,7.603,8.16,9.561,12.259,1.958,4.098,10.367,5.711,10.482,8.245.115,2.534.691,4.147-.461,4.262-1.152.115-5.529.346-8.178-2.073-2.649-2.419-4.608-3.801-6.335-6.22-1.728-2.419-3.225-5.299-4.032-9.1-.806-3.801-3.11-9.1-3.11-9.1l2.073,1.728Z"
              onClick={(e) => handleAreaClick('Left 1st Finger', e)}
            />
            ...
            <path 
              id="Right Larynx"
              className="body-area"
              fill={getAreaColor('Right Larynx')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Larynx', e)}
            />
            ...
            <path 
              id="Left Larynx"
              className="body-area"
              fill={getAreaColor('Left Larynx')}
              stroke="#374151" 
              strokeWidth="1"
              d="M297.761,110.602c-.194,8.985-1.311,24.074-.123,27.414,1.188,3.34,4.036-8.524,7.911-16.703,3.875-8.178,2.416-5.107,3.453-8.793,1.037-3.686,7.103-3.341,2.957-3.686-4.147-.346-14.198,1.767-14.198,1.767Z"
              onClick={(e) => handleAreaClick('Left Larynx', e)}
            />
            
            {/* Right Pubis Adductor */}
            <path 
              id="Right Pubis Adductor"
              className="body-area"
              fill={getAreaColor('Right Pubis Adductor')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Pubis Adductor', e)}
            />
            
            {/* Left Pubis Adductor */}
            <path 
              id="Left Pubis Adductor"
              className="body-area"
              fill={getAreaColor('Left Pubis Adductor')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Pubis Adductor', e)}
            />
            
            {/* Right Adductor Long */}
            <path 
              id="Right Adductor Long"
              className="body-area"
              fill={getAreaColor('Right Adductor Long')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Adductor Long', e)}
            />
            
            {/* Left Adductor Long */}
            <path 
              id="Left Adductor Long"
              className="body-area"
              fill={getAreaColor('Left Adductor Long')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Adductor Long', e)}
            />
            
            {/* Right Adductor Short */}
            <path 
              id="Right Adductor Short"
              className="body-area"
              fill={getAreaColor('Right Adductor Short')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Adductor Short', e)}
            />
            
            {/* Left Adductor Short */}
            <path 
              id="Left Adductor Short"
              className="body-area"
              fill={getAreaColor('Left Adductor Short')}
              stroke="#374151" 
              strokeWidth="1"
              d="M307.627,450.758c4.262,6.335,10.021,12.231,9.906,14.237-.115,2.005-5.99,32.415-5.644,35.871-3.571-3.456-6.911-44.924-6.681-48.726.23-3.801,2.419-1.382,2.419-1.382Z"
              onClick={(e) => handleAreaClick('Left Adductor Short', e)}
            />
            ...
            <path 
              id="Right Patella"
              className="body-area"
              fill={getAreaColor('Right Patella')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Patella', e)}
            />
            ...
            <path 
              id="Left Patella"
              className="body-area"
              fill={getAreaColor('Left Patella')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Patella', e)}
            />
            
            {/* Right Medial Knee */}
            <path 
              id="Right Medial Knee"
              className="body-area"
              fill={getAreaColor('Right Medial Knee')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Medial Knee', e)}
            />
            ...
            <path 
              id="Left Medial Knee"
              className="body-area"
              fill={getAreaColor('Left Medial Knee')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Medial Knee', e)}
            />
            ...
            <path 
              id="Right Calf Front"
              className="body-area"
              fill={getAreaColor('Right Calf Front')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Calf Front', e)}
            />
            ...
            <path 
              id="Left Calf Front"
              className="body-area"
              fill={getAreaColor('Left Calf Front')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Calf Front', e)}
            />
            ...
            <path 
              ...
              onClick={(e) => handleAreaClick('Right Ankle', e)}
            />
            ...
            <path 
              ...
              onClick={(e) => handleAreaClick('Left Ankle', e)}
            />
            
            {/* Right Ankle Ligaments */}
            <path 
              id="Right Ankle Ligaments"
              className="body-area"
              fill={getAreaColor('Right Ankle Ligaments')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Ankle Ligaments', e)}
            />
            
            {/* Left Ankle Ligaments */}
            <path 
              id="Left Ankle Ligaments"
              className="body-area"
              fill={getAreaColor('Left Ankle Ligaments')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Ankle Ligaments', e)}
            />
            ...
            <path 
              id="Right Foot Front"
              className="body-area"
              fill={getAreaColor('Right Foot Front')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Foot Front', e)}
            />
            ...
            <path 
              id="Left Foot Front"
              className="body-area"
              fill={getAreaColor('Left Foot Front')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Foot Front', e)}
            />
            ...
            <path 
              id="Right Feet Toe"
              className="body-area"
              fill={getAreaColor('Right Feet Toe')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Feet Toe', e)}
            />
            ...
            <path 
              id="Left Feet Toe"
              className="body-area"
              fill={getAreaColor('Left Feet Toe')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Feet Toe', e)}
            />
            
            {/* Right Sternocleidomastoideus */}
            <path 
              id="Right Sternocleidomastoideus"
              className="body-area"
              fill={getAreaColor('Right Sternocleidomastoideus')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Sternocleidomastoideus', e)}
            />
            
            {/* Left Sternocleidomastoideus */}
            <path 
              id="Left Sternocleidomastoideus"
              className="body-area"
              fill={getAreaColor('Left Sternocleidomastoideus')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Sternocleidomastoideus', e)}
            />
            ...
            <path 
              id="Right Trap Front"
              className="body-area"
              fill={getAreaColor('Right Trap Front')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Trap Front', e)}
            />
            ...
            <path 
              id="Left Trap Front"
              className="body-area"
              fill={getAreaColor('Left Trap Front')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Trap Front', e)}
            />
            ...
            <path 
              id="Right Trapezius"
              className="body-area"
              fill={getAreaColor('Right Trapezius')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Trapezius', e)}
            />
            ...
            <path 
              id="Left Trapezius"
              className="body-area"
              fill={getAreaColor('Left Trapezius')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Trapezius', e)}
            />
            
            {/* Right Intercostal */}
            <path 
              id="Right Intercostal"
              className="body-area"
              fill={getAreaColor('Right Intercostal')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Intercostal', e)}
            />
            ...
            <path 
              id="Left Intercostal"
              className="body-area"
              fill={getAreaColor('Left Intercostal')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Intercostal', e)}
            />
            ...
            <path 
              id="Right Oblique"
              className="body-area"
              fill={getAreaColor('Right Oblique')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Oblique', e)}
            />
            ...
            <path 
              id="Left Oblique"
              className="body-area"
              fill={getAreaColor('Left Oblique')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Oblique', e)}
            />
            ...
            <path 
              id="Right Pubic Area"
              className="body-area"
              fill={getAreaColor('Right Pubic Area')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Right Pubic Area', e)}
            />
            ...
            <path 
              id="Left Pubic Area"
              className="body-area"
              fill={getAreaColor('Left Pubic Area')}
              stroke="#374151" 
              strokeWidth="1"
              ...
              onClick={(e) => handleAreaClick('Left Pubic Area', e)}
            />
        ...
        <div className="bg-slate-800 p-4 border-b border-slate-600">
          <div className="flex justify-between items-center mb-3">
            ...
            <h3 className="text-lg font-semibold text-slate-200">
              Body {mode === 'pain' ? 'Pain' : 'Soreness'} Assessment
            </h3>
          ...
          <p className="text-sm text-slate-300 text-center">
            Click on body areas to cycle through {mode} levels (1-10). Click repeatedly to increase {mode} level, or click until it resets to deselect.
          </p>
        </div>
